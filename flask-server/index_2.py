...
list = 2
condition = '6000'
condition_type = 'dFirst'
eval_pbk = f'L{list}_Melissa_Dfirst'
...
pbk = WavAudio(f'{eval_pbk}.wav',cfg,f'data/audio/pbk/normals/deletion/')
# pbk.plot_amp('inc', 4300, 4960)
# pbk.n_segments_fixed(4300, 4960, 50)
pbk.classify_cache_speechmatics(f'data/json/segmented_norms/L{list}_{condition_type}/{eval_pbk}/')
#########################
